...
#if NO_ASYNC
		/// <summary>
		/// Event, triggered before command execution using <see cref="DbCommand.ExecuteScalar()"/> async method.
		/// </summary>
		/// <param name="eventData">Additional data for event.</param>
		/// <param name="command">Command, prepared for execution.</param>
		/// <param name="result">Value, returned by previous interceptor when multiple <see cref="ICommandInterceptor"/> instances registered or <see cref="Option{T}.None"/>.</param>
...
#if NO_ASYNC
		/// <summary>                    
		/// Event, triggered before command execution using <see cref="DbCommand.ExecuteNonQuery()"/> async method.
		/// </summary>
		/// <param name="eventData">Additional data for event.</param>
		/// <param name="command">Command, prepared for execution.</param>
		/// <param name="result">Value, returned by previous interceptor when multiple <see cref="ICommandInterceptor"/> instances registered or <see cref="Option{T}.None"/>.</param>
...
#if NO_ASYNC
		/// <summary>
		/// Event, triggered before command execution using <see cref="DbCommand.ExecuteReader(CommandBehavior)"/> async method.
		/// </summary>
		/// <param name="eventData">Additional data for event.</param>
		/// <param name="command">Command, prepared for execution.</param>
		/// <param name="commandBehavior">Behavior, used for command execution.</param>
...
#if NO_ASYNC
		/// <summary>
		/// Event, triggered after command execution using <see cref="DbCommand.ExecuteReader(CommandBehavior)"/> sync and async methods.
		/// </summary>
		/// <param name="eventData">Additional data for event.</param>
		/// <param name="command">Executed command.</param>
		/// <param name="commandBehavior">Behavior, used for command execution.</param>
		/// <param name="dataReader"><see cref="DbDataReader"/> instance, returned by <see cref="DbCommand.ExecuteReader(CommandBehavior)"/> method.</param>
#else
		/// <summary>
